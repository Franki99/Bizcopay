...
private val BizcopayColorScheme = lightColorScheme(
    primary           = BizcoBlue,
    onPrimary         = BizcoOnDark,
    primaryContainer  = BizcoBlueLight,
    onPrimaryContainer = BizcoBlue,
    secondary         = BizcoGreen,
    onSecondary       = BizcoOnDark,
